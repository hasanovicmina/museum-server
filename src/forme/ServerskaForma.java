...
public class ServerskaForma extends javax.swing.JFrame {
    ...
    public ServerskaForma() {
        initComponents();
        this.setTitle("Server Narodnog muzeja");
    ...
    private void initComponents() {
        ...
        tblServerZaposleni = new javax.swing.JTable();
        ...
        jLabel1.setText("Dobrodošli u aplikaciju Narodnog Muzeja!");

        jPanel1.setBackground(new java.awt.Color(235, 232, 221));
        jPanel1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));

        tblServerZaposleni.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(tblServerZaposleni);
        ...
        lblServer.setFont(new java.awt.Font("Lucida Bright", 1, 18)); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(20, 20, 20)
                .addComponent(btnPokreni, javax.swing.GroupLayout.PREFERRED_SIZE, 154, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(btnZaustavi, javax.swing.GroupLayout.PREFERRED_SIZE, 154, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(20, 20, 20))
            .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void btnZaustaviActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnZaustaviActionPerformed
        ...
        try {
            ps.ugasi();
          //  ModelTabeleZaposleni mtz = (ModelTabeleZaposleni) tblServerZaposleni.getModel();
          //  mtz.obrisiSveZaposlene();
    ...
    private javax.swing.JTable tblServerZaposleni;
    ...
    private void srediTabelu(ArrayList<OpstiDomenskiObjekat> listaZaposlenih) {
        ModelTabeleZaposleni mtz = new ModelTabeleZaposleni(listaZaposlenih);
        tblServerZaposleni.setModel(mtz);

    }
    
   public ModelTabeleZaposleni vratiTabeluZaposlenih(){
       return (ModelTabeleZaposleni) tblServerZaposleni.getModel();
   }
